...
bool Shimeji::setShape(Window wnd, const sf::Image& image) {
...
bool Shimeji::setTransparency(Window wnd, unsigned char alpha) {
    Display* display = XOpenDisplay(NULL);
...
void Shimeji::resizeImage(const sf::Image& originalImage, sf::Image& resizedImage) {
